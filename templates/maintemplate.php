      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/crypto">Криптовалюта</a></li>
              <li><a href="/fund">Фундаментальный анализ</a></li>
              <li><a href="/tech">Технический анализ</a></li>
          ...
          <li class="mb">    
            <a class="sub-menu" href="/contact-us">
