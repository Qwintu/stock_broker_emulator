...
class User{
  ...
  global $mysqli;
  $result = $mysqli->query("SELECT `LKOH`, `LKOH_price`, `GAZP`, `GAZP_price`, `ROSN`, `ROSN_price`, `SBER`, `SBER_price`, `TATN`, `TATN_price`, `TATN_limit`, `GMKN`, `GMKN_price`, `POLY`, `POLY_price`, `POLY_limit`, `AFKS`, `AFKS_price`, `MOEX`, `MOEX_price`, `MOEX_limit`, `VTBR`, `VTBR_price`, `NLMK`, `NLMK_price`, `NLMK_limit` FROM `User` WHERE `id`='$id'");
    $userinfo = [];
